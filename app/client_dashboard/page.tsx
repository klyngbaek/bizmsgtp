  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="flex flex-col items-center justify-between">
        <ClientDashboard app_id={app_id} app_name={app_name} bm_id={business_id} user_id={userId} tp_configs={tp_configs} public_es_feature_options={public_es_feature_options} public_es_versions={public_es_versions} public_es_feature_types={public_es_feature_types} />
      </div>
    </div >
  );
},
